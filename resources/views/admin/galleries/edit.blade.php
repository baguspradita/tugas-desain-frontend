...
@section('content')
    ...
    <div class="card">
        <h3 style="margin-top:0;">Edit Galeri</h3>
        <form method="POST" action="{{ route('admin.galleries.update', $item) }}" enctype="multipart/form-data">
            ...
            <input type="number" name="display_order" min="0" value="{{ old('display_order', $item->display_order) }}">
            ...
            <div style="margin-top:12px; display:flex; gap:10px;">
                ...
                <a class="btn btn-secondary" href="{{ route('admin.galleries.index') }}">Kembali</a>
            </div>
        </form>
    </div>
@endsection
